...
#'
#' @references Zhao Z, Wang S, Zucknick M and Aittokallio T (2022). \emph{Tissue-specific identification of multi-omics features for pan-cancer drug response prediction}. iScience, 25(8): 104767.
#' 
#' @examples
#' # Load data
