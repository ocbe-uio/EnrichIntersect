...
The example data object `cancers_drug_groups` is an R `list` provided in
...
The `EnrichIntersect` function `intersectSankey()` creates a Sankey
...
[10.1093/bioadv/vbac073](https://doi.org/10.1093/bioadv/vbac073).
